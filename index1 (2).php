        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto o" href="#requisicoes">Requisições</a></li>
...
<div id="loginModal" class="modal fade" tabindex="-1" role="dialog">
                            ...
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon" href="#">
                                        <i class="ri ri-shake-hands-line" aria-hidden="true"></i>
                                    </a>
                                    <h4>Consultoria</h4>
                                    <p>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class=" about-move">                           
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon" href="#">
                                        <i class="bx bxs-credit-card" aria-hidden="true"></i>
                                    </a>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <section id="requisicoes" class="requisicoes section-bg">
                <div class="container">
                            ...
                            <form action="php/process.php" method="POST" id="form-requisicao">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" class="br form-control" id="data_nascimento" name="data_nascimento" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div class="form-group" id="outros_info_div" style="display: none;">
                                    ...
                                    <input type="text" class="br form-control" id="outros_info" name="outros_info" maxlength="200">
                                </div>
...
<!-- Inclua os ícones do Bootstrap Icons se ainda não estiverem incluídos -->
                            ...
                            <div class="faq-list">
                                <ul>
                                    ...
                                    <li data-aos="fade-up" data-aos-delay="300">
                                        <i class="bx bx-help-circle icon-help"></i>
                                        <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-4">
                                    ...
                                    <li data-aos="fade-up" data-aos-delay="400">
                                        <i class="bx bx-help-circle icon-help"></i>
                                        <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-5">
                                    ...
                                    <li data-aos="fade-up" data-aos-delay="500">
                                        <i class="bx bx-help-circle icon-help"></i>
                                        <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-6">
                                    ...
                                    <li data-aos="fade-up" data-aos-delay="600">
                                        <i class="bx bx-help-circle icon-help"></i>
                                        <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-7">
                                    ...
                                    <li data-aos="fade-up" data-aos-delay="700">
                                        <i class="bx bx-help-circle icon-help"></i>
                                        <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-8">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <h3><?php echo htmlspecialchars($nome, ENT_QUOTES, 'UTF-8'); ?></h3>
                                        </div>
                                    </div><!-- Fim Item Depoimentos -->
                                    <?php
                                    }
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4></h4>
                        <ul>
                            <li><i class="bx bx-phone-incoming"></i> <a href="#">(11)94801-6298</a></li>
                            <li><i class="bx bx-envelope-open"></i> <a href="#">contato@confinter.com.br</a></li>                            
                        </ul>
                    </div>
